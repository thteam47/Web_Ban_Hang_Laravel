				...
				<form role="form" action="" enctype="multipart/form-data"  method="POST" class="form-horizontal ">
					...
					<div class="form-group has-success anh">
						...
						<div class="col-lg-6">
							...
							<img id="avatar" style="cursor: pointer;" class="thumbnail" width="200px" src="{{asset('storage/app/advImg/'.$adv->p_image)  }}">
						</div>
					</div>
					...
					<div class="form-group">
						<div class="text-center">
							<button class="btn btn-success" type="submit">Thêm quảng cáo</button>
						</div>
					</div>
